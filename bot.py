...
user_data = {}
admin_states = {}  # Для хранения состояния админ-действий
...
# Обработчик рассылки через обычное сообщение
@dp.message()
...
# ========== ОСТАЛЬНЫЕ ОБРАБОТЧИКИ (сокращены) ==========
...
async def handle_words_input(message: Message):
    ...
    # Проверяем, не админ ли это в режиме ввода
    if user_id in admin_states:
        return
